...
export const RxGridList: <T>(props: RxGridListProps<T>) => React.ReactElement = liftReactList(GridList) as any
...
export const RxGridListWindow: <T>(props: RxGridListWindowProps<T>) => React.ReactElement = liftReactList(
  GridListWindow,
) as any
