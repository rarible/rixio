...
type InferHtmlProps<K extends keyof React.ReactHTML> =
	React.ReactHTML[K] extends DetailedHTMLFactory<infer P, any> ? P : never

type InferHtmlElementType<K extends keyof React.ReactHTML> =
	React.ReactHTML[K] extends DetailedHTMLFactory<any, infer T> ? T : never
