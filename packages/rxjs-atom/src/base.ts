...
export interface ReadOnlyAtom<T> extends Observable<T> {
	 ...
	 * View this atom at a give property path.
	 */
	view<K1 extends keyof T, K2 extends keyof T[K1], K3 extends keyof T[K1][K2], K4 extends keyof T[K1][K2][K3]>(
		k1: K1,
		k2: K2,
		k3: K3,
		k4: K4
...
export interface Atom<T> extends ReadOnlyAtom<T> {
	 ...
	 * Create a lensed atom that's focused on a given property path.
	 */
	lens<K1 extends keyof T, K2 extends keyof T[K1], K3 extends keyof T[K1][K2], K4 extends keyof T[K1][K2][K3]>(
		k1: K1,
		k2: K2,
		k3: K3,
		k4: K4
